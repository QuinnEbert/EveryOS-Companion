...
;@Quinn: On July 04th (no kidding!) of 2009, modified this so it works more "comfortably" now that I have an M-Audio Delta handling "off-host" Input (Fewer output interfaces!)
Dim $n = 120
$n += ((Int($CmdLine[1]) * 56) - 56)
