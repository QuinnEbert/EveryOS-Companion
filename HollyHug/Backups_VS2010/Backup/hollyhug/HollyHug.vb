...
Public Class HollyHug
    ...
    Private Sub HollyHug_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        HollyNetToolStripMenuItem.Enabled = False
        If Is_Debug() Then
            HollyNetToolStripMenuItem.Enabled = True
        End If
        If Me.InitLoad Then
            Me.InitLoad = False
            Me.Visible = False
            ...
            ElseIf pi(i).Name = PLStatus Then
                ...
                If Not PowerSrc = NewState Then
                    If NewState = Power_AC Then
                        ...
                        BalloonMessage("I am now running on AC outlet power!  I'm glad to finally be taking a nap!  :-)", "Now On Mains/AC Power")
                    Else
                        SayAloud("Reddie to Rock!")
                        BalloonMessage("I am now running on battery power!  I look forward to taking a nice trip!  :-)", "Now On Battery Power")
                    End If
                End If
                PowerSrc = NewState
            End If
