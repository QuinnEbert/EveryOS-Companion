...
Public Class HollyNetServer
    ...
    Public Sub ServLoop()
        If HollyHug.Is_Debug() Then HollyHug.LogPrint("HollyHug: LOOP TOP")
        ...
        Catch e As SocketException
            ...
            server.Stop()
        End Try
        If HollyHug.Is_Debug() Then HollyHug.LogPrint("HollyHug: LOOP END")
    End Sub
End Class
